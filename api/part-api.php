...
// if($auth->isAuth()){
    ...
    break;
        ...
        case "update":
            ...
            $items = array("part_number"=>$part_number, "description"=>$part_description, "vendor"=>$vendor_name, "vendor_number"=>$vendor_number, "length"=>$length, "width"=>$width, "height"=>$height, "standard_pack"=>$quantity, "weight"=>$weight, "weigh_uom"=>$weight_uom, "reusable"=>$reusable, "stackable"=>$stackable, "container_type"=>$container_type, "container_number"=>$container_number, "container_uom"=>$container_uom, "active"=>$active, "date_modified"=>$date, "modified_by"=>$user);
        ...
        case "add_part":
            ...
            $part = array($part_number,$part_description,$vendor_name,$vendor_number,$length, $width, $height, $quantity, $weight, $weight_uom, $reusable, $stackable, $container_type, $container_uom,  $container_number, $active, $date, $user);
            $insert_part = $conn->prepare("INSERT INTO `parts` (`part_number`, `description`, `vendor`, `vendor_number`, `length`, `width`, `height`, `standard_pack`, `weight`, `weigh_uom`, `reusable`, `stackable`, `container_type`, `container_uom`, `container_number`, `active`, `date_modified`, `modified_by`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
